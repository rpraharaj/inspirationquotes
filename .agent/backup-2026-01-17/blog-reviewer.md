...
> **📚 Standards Reference:** See `/blog-quality-standards` for human voice rules, banned phrases, and E-E-A-T requirements.
...
| Pass | Purpose | Time |
|------|---------|------|
| **Pass 1** | Content Enhancement | ~5 min |
| **Pass 2** | Humanization | ~5 min |
| **Pass 3** | Fact-Checking | ~5 min |
| **Pass 4** | Citation & Links | ~5 min |

**All four passes are REQUIRED.** Do not skip any pass.
...
> **Full reference:** `/blog-quality-standards#1-human-voice-requirements` and `/blog-quality-standards#2-ai-banned-phrases`
...
> **Information currency rules:** `/blog-quality-standards#3-information-currency-rules`
...
**Goal:** Add high-quality external links for claims needing citation.

> **Full reference:** `/blog-quality-standards#7-external-linking-requirements`
