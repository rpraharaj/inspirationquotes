...
> **📚 Standards Reference:** All validation rules defined in `/blog-quality-standards`. This workflow checks compliance.
...
> **Full requirements:** `/blog-quality-standards#9-seo-on-page-requirements`
...
> **Full requirements:** `/blog-quality-standards#8-word-count-requirements`
...
> **Full requirements:** `/blog-quality-standards#1-human-voice-requirements` and `/blog-quality-standards#2-ai-banned-phrases`
