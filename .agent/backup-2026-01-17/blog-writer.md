...
> **📚 Standards Reference:** This workflow requires strict adherence to `/blog-quality-standards`. Review it before starting.
...
> **Complete reference:** `/blog-quality-standards#1-human-voice-requirements` and `/blog-quality-standards#2-ai-banned-phrases`
...
> **See `/blog-quality-standards#6-internal-linking-requirements`**
...
> **See `/blog-quality-standards#7-external-linking-requirements`**
