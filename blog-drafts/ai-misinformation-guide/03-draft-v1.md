# Draft v1: AI-Generated Misinformation: The Growing Threat
...
In 2025 alone, losses from AI-enhanced fraud exceeded billions of dollars globally. This isn't a future threat—it's happening now.
...
- **Deepfake detection platforms**: Several services specifically analyze video for AI manipulation
...
**C2PA (Coalition for Content Provenance and Authenticity)** brings together major companies to develop content authentication standards. This "content credentials" approach embeds verification information in media files.
...
Useful tools include reverse image search (Google Images, TinEye), deepfake detection platforms, fact-checking websites (Snopes, FactCheck.org), and AI text detection tools. For calls claiming to be family members, hang up and call back on a known number. No single tool is perfect—use multiple approaches together.
