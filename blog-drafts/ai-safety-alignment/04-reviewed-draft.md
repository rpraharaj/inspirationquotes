...
[Mechanistic interpretability research](https://deepmind.google) at organizations like DeepMind aims to open these black boxes, but it's still early days. For now, we can't fully explain how advanced AI makes its decisions, which makes ensuring alignment that much harder.
