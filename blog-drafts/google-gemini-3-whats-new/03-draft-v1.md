...
The benchmark numbers back this up: Gemini 3 Pro scored 93.8% on GPQA Diamond (PhD-level knowledge) and 95.0% on AIME 2025 (advanced math).
...
Claude Opus 4.5 still leads on pure code accuracy. If you're reviewing code for production deployment and accuracy is paramount, Claude edges out the competition.
