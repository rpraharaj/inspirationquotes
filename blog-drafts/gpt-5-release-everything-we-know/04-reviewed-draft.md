...
GPT-5 is [OpenAI's fifth-generation multimodal large language model](https://openai.com), released on August 7, 2025. It features a unified architecture that integrates reasoning, vision, memory, and autonomous task execution. GPT-5 is available through ChatGPT, Microsoft Copilot, and the OpenAI API, supporting text, image, audio, and video inputs.
...
| [SWE-Bench Verified](https://www.swebench.com/) | 80.0% | Real-world software engineering (Python) |
...
One of the more interesting developments in late 2025 was [Apple's integration of GPT-5 into Apple Intelligence](https://www.apple.com/apple-intelligence/) across iOS 26, iPadOS 26, and macOS Tahoe 26.
