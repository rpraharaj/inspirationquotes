...
heroImage: "../../assets/images/mcp-server-directory.webp"
...
Let's start with the foundation. Anthropic maintains several official MCP servers in the [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers) repository. These are your safest bet—they're well-documented, regularly updated, and work reliably with Claude Desktop.
...
For more on enterprise deployment, check the [Anthropic enterprise documentation](https://modelcontextprotocol.io).
...
- [GitHub search](https://github.com/search?q=mcp-server) - Raw search
