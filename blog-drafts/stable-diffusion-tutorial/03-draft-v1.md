...
Download from [python.org](https://www.python.org/downloads/). During installation, make sure to check "Add Python to PATH."
...
Download from [git-scm.com](https://git-scm.com/). Use default installation options.
...
Models are large files (2-7GB). Download SDXL from [Hugging Face](https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0) or SD 1.5 from [Hugging Face](https://huggingface.co/runwayml/stable-diffusion-v1-5).
...
If AUTOMATIC1111's WebUI feels too slow or complex, consider [ComfyUI](https://github.com/comfyanonymous/ComfyUI). It uses a node-based interface that's more visual and often faster. The installation process is similar.
...
Small files (10-200MB) that modify the model's output—adding specific characters, styles, or concepts. Thousands are available on [Civitai](https://civitai.com/).
...
[Civitai](https://civitai.com/) and [PromptHero](https://prompthero.com/) show prompts used to create popular images. Study what works.
