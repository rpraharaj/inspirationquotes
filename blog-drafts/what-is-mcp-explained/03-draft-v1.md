...
MCP stands for **Model Context Protocol**. It was introduced by [Anthropic](https://anthropic.com) in November 2024 as an open-source standard for connecting AI applications to external tools and data sources.
...
**Google (Gemini)** - Announced support in May 2025. Google has since launched fully managed MCP servers for their services like Maps, BigQuery, and cloud infrastructure. They're treating MCP as production infrastructure, not an experiment.
...
In December 2025, Anthropic donated MCP to the newly formed Agentic AI Foundation (AAIF), which operates as a directed fund under the Linux Foundation.
...
Where can you find more? The official [Model Context Protocol server directory](https://modelcontextprotocol.io) is the best starting point. GitHub searches also surface many community servers.
...
The Python and TypeScript SDKs are the most mature and widely used. The [MCP documentation](https://modelcontextprotocol.io) provides excellent getting-started guides.
