---
heroImage: "/images/featured/ai-hallucinations-explained.webp"
...
According to research published in 2025, models like OpenAI's o3 and o4-mini, and DeepSeek's R1, have shown hallucination rates of 30-50%—significantly higher than some earlier models. See <a href="https://huggingface.co/spaces/vectara/Hallucination-evaluation-leaderboard" target="_blank" rel="noopener">Vectara's Hallucination Leaderboard</a> for current statistics.
...
For factual questions, search engines with AI features (like <a href="https://perplexity.ai" target="_blank" rel="noopener">Perplexity</a>) that cite sources are more reliable than chat-based models.
