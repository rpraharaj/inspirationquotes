---
heroImage: "/images/featured/ai-web-scraping-tutorial.webp"
...
Traditional scrapers rely on CSS selectors or XPath expressions (using libraries like <a href="https://www.crummy.com/software/BeautifulSoup/bs4/doc/" target="_blank" rel="noopener">BeautifulSoup</a>):
...
2. **Token costs add up.** Processing large pages through GPT-5.2 costs money. (Learn more about [understanding tokens and API pricing](/blog/tokens-in-ai-explained).)
...
- Respecting <a href="https://developers.google.com/search/docs/crawling-indexing/robots/intro" target="_blank" rel="noopener">robots.txt directives</a>
...
For large-scale scraping, rotating residential IPs prevents blocks. Services like Bright Data or Oxylabs provide this, but costs add up.
