---
heroImage: "/images/featured/context-window-explained.webp"
...
At the heart of modern LLMs is something called the <a href="https://arxiv.org/abs/1706.03762" target="_blank" rel="noopener">transformer architecture</a>. And at the heart of transformers is the attention mechanism—how the model weighs relationships between different parts of the text.
...
Even when models technically support large contexts, performance isn't uniform throughout the window. <a href="https://arxiv.org/abs/2307.03172" target="_blank" rel="noopener">Research has consistently shown</a> that LLMs pay more attention to information at the beginning and end of the context, while information in the middle tends to get "lost."
