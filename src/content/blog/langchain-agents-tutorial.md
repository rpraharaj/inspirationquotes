...
heroImage: "/images/featured/langchain-agents-tutorial.webp"
category: "ai-agents"
...
In this tutorial, I'll walk you through building LangChain agents from scratch. We'll start with the basics, then level up to <a href="https://python.langchain.com/docs/langgraph" target="_blank" rel="noopener">LangGraph</a> for more complex workflows. By the end, you'll have working code you can actually run and extend for your own projects.
...
- **OpenAI API key** (<a href="https://platform.openai.com/api-keys" target="_blank" rel="noopener">get one here</a>)
...
For specialized integrations, see our tutorials on building an [AI voice assistant with Python](/blog/ai-voice-assistant-python), [AI-powered web scraping](/blog/ai-web-scraping-tutorial), or integrating with [GitHub via MCP](/blog/mcp-github-server).
...
That's where <a href="https://langchain-ai.github.io/langgraph/" target="_blank" rel="noopener">LangGraph</a> comes in.
