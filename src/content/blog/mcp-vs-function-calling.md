---
heroImage: "/images/featured/mcp-vs-function-calling.webp"
...
<a href="https://platform.openai.com/" target="_blank" rel="noopener">OpenAI</a> popularized this approach with GPT-3.5 and GPT-4 in 2023. Here's what a typical function calling integration looks like with the OpenAI API:
...
**MCP** is vendor-agnostic. It's an open standard now governed by the <a href="https://www.linuxfoundation.org" target="_blank" rel="noopener">Linux Foundation</a>. Build an MCP server once, and it works with any MCP-compatible client.
