...
pubDate: 2025-09-06
heroImage: "/images/featured/vector-databases-explained.webp"
category: "tutorials"
...
An embedding is an array of floating-point numbers—typically 384 to 4,096 numbers depending on the model. (Understanding [how tokens work in AI](/blog/tokens-in-ai-explained) helps grasp why embeddings have specific dimensions.) Here's what a tiny portion of an embedding might look like:
...
<a href="https://www.pinecone.io" target="_blank" rel="noopener">Pinecone</a> is the most polished managed vector database. You create an index, insert vectors, and query—that's it. No infrastructure to manage, no tuning required, auto-scaling handles traffic spikes.
...
<a href="https://weaviate.io" target="_blank" rel="noopener">Weaviate</a> combines vector search with traditional search capabilities ("hybrid search"). It also has built-in modules for generating embeddings, so you can insert raw text and Weaviate handles embedding.
...
<a href="https://www.trychroma.com" target="_blank" rel="noopener">Chroma</a> is the easiest vector database to start with. Install it via pip, and you're running a local vector database in seconds. It's perfect for learning, prototyping, or smaller applications.
