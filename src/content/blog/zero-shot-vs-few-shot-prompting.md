---
heroImage: "/images/featured/zero-shot-vs-few-shot-prompting.webp"
...
**Self-consistency prompting** generates multiple responses and selects the most frequent answer—ideal for complex reasoning where a single response may be unreliable. See the <a href="https://arxiv.org/abs/2203.11171" target="_blank" rel="noopener">self-consistency research</a> for details.

**Least-to-most prompting** breaks complex problems into simpler subproblems, solving them incrementally. This helps when few-shot examples alone can't capture the full reasoning process. The <a href="https://arxiv.org/abs/2205.10625" target="_blank" rel="noopener">original research</a> demonstrates impressive results on complex reasoning tasks.
...
These techniques build on few-shot foundations—master the basics first. You can also combine few-shot with [role prompting](/blog/role-prompting) for even more control over outputs.
